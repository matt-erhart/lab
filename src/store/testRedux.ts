...
const ids = Object.keys(getState().graph.nodes).slice(0, 5)
dispatch.graph.removeBatch({nodes: ids})
// const updates = vbs
//   .slice(0, 300)
...
//   id: vbs[0].id,
//   data: {height: 1, }
// } as NestedPartial<typeof vbs[0]>;
// const nodeUpdate2 = {
//     id: vbs[1].id,
//     data: {height: 222, }
//   } as NestedPartial<typeof vbs[0]>;
// dispatch.graph.updateBatch( {nodes: [nodeUpdate, nodeUpdate2]});
